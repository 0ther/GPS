...
bool CLIENT_INTERFACE::SendFlag = 0;
...
void CLIENT_INTERFACE::User_Console() {
  ...
  std::cout << "Доступные операции: " << std::endl;
	std::cout << "1. Включить геренацию сообщений" << std::endl;
	std::cout << "2. Отключить генерацию сообщений" << std::endl;
  std::cout << "3. Включить передачу данных" << std::endl;
  std::cout << "4. Отключить передачу данных" << std::endl;
  std::cout << "5. Разлогиниться" << std::endl;
